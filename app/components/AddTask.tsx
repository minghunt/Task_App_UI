            ...
            <div className='modal-action'>
              ...
              />
                <div className="flex mb-2 mt-4 ">
                    ...
                    <input type="checkbox" onChange={(e)=>setTaskCompleted(Boolean(e.target.value))} size={50} defaultChecked={taskCompleted} className='checkbox checkbox-secondary w-8 h-8' />
                </div>
              </div>
            </div>
